...
public class LoginView {
    ...
    public Parent build() {
        ...
        actionBtn.setOnAction(e -> {
            ...
            if (loginMode) {
                ...
                if (App.userRepo.getUserByEmail(email) != null) {
                    error.setText("Un compte avec cet email existe déjà.");
                    return;
                }
    ...
    private void applyTabStyle(Button btn, boolean active) {
        ...
        if (active) {
            btn.setStyle(
                    base + "-fx-background-color: " + App.ACCENT + "; -fx-text-fill: white; -fx-background-radius: 4;");
        } else {
            btn.setStyle(base + "-fx-background-color: " + App.CARD + "; -fx-text-fill: " + App.DIM
